...
export default function UserProfile() {
  ...
  if (isLoading) {
    return (
      <div className="w-auto lg:-mx-4 xl:-mx-8 space-y-6 animate-pulse">
        {/* Header Skeleton */}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm flex items-center justify-between">
        ...
        {/* Tabs Skeleton */}
        <div className="bg-[#f8f9fa] border border-gray-100 rounded-xl p-2 flex items-center space-x-6 px-6">
        ...
        <div className="bg-white rounded-2xl p-6 sm:p-8 border border-gray-100 shadow-sm space-y-6">
          <div className="flex items-center space-x-4 bg-gray-50 border border-gray-100 rounded-2xl p-5">
