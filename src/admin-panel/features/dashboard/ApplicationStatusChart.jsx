...
const data = [
  { name: 'Approved', value: 4280, color: '#10B981' }, // Green
  { name: 'Pending', value: 1240, color: '#F59E0B' },  // Yellow
  { name: 'Rejected', value: 386, color: '#EF4444' },  // Red
  { name: 'Review', value: 612, color: '#3B82F6' },    // Blue
];
